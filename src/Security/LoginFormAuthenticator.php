...
//        assert($user instanceof User);
     ...
     */
    final public function getPassword($credentials): ?string
    {
        return $credentials['password'];
    }

    final public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey): RedirectResponse
    {
